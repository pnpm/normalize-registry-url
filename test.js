...
test('normalizeRegistrUrl()', t => {
  ...
  t.equal(normalizeRegistrUrl('//registry.npmjs.org/foo/'), '//registry.npmjs.org/foo/')
  t.equal(normalizeRegistrUrl('https://registry.example.com:443/'), 'https://registry.example.com/')
  t.equal(normalizeRegistrUrl('http://registry.example.com:80/'), 'http://registry.example.com/')
  t.equal(normalizeRegistrUrl('https://registry.example.com:8443/'), 'https://registry.example.com:8443/')
  t.equal(normalizeRegistrUrl('http://registry.example.com:8080/'), 'http://registry.example.com:8080/')
  t.end()
})
